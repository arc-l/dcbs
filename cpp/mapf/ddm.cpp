    ...
    while(true){
        ...
        if (!collided_robots.empty()) {
            ...
            for (auto collided_robot_pair : collided_robots) {
                ...
                // printf("collided %d with %d  (%d,%d) and (%d,%d)\n",r1,r2,plan.last(r1)->pos.x,plan.last(r1)->pos.y,
